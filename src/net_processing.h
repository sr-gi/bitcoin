...
public:
    ...
    */
    ...
    virtual std::optional<std::chrono::microseconds> GetTxFirstAnnouncementTime(const uint256& txid) const = 0;

    virtual std::optional<std::chrono::microseconds> GetTxFirstSeenTime(const uint256& txid) const = 0;
};
